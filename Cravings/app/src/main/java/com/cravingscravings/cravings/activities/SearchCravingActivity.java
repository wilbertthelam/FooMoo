...
public class SearchCravingActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
            // Sets craving on database and brings user back to MainDisplayActivity
            public boolean onQueryTextSubmit(String query) {
                ...
                // Return to MainDisplayActivity
                Intent i = new Intent(SearchCravingActivity.this, MainDisplayActivity.class);
                startActivity(i);
                return true;
            }
