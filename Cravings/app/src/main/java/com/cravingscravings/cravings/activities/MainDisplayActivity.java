package com.cravingscravings.cravings.activities;
...
import com.cravingscravings.cravings.fragments.EventListFragment;
import com.cravingscravings.cravings.fragments.FriendFeedFragment;
...
public class MainDisplayActivity extends AppCompatActivity {
        ...
        class AddUserTask extends AsyncTask<String, String, String> {
            ...
            protected void onPostExecute(String result) {
                ...
                if (result.equals("success")) {
                    ...
                    LoginManager.getInstance().logOut();
                    Intent intent = new Intent(MainDisplayActivity.this, LoginActivity.class);
                    startActivity(intent);
                }
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int pos) {
            switch(pos) {
                case 0: return FriendFeedFragment.newInstance(currentUserId);
                case 1: return EventListFragment.newInstance(currentUserId);
                default: return FriendFeedFragment.newInstance(currentUserId);
            }
        }
